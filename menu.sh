...
echo -e "${yl}┌─────────────────────────────────────────────────────────────┐${yl}"
echo -e "${yl}│   $yy 1$wh.  SSH $wh   $yy[${wh}Menu$yy]      $y┃$yy 7$wh.  BANDWIDTH$wh $yy[${wh}Menu$yy]              │${yl}"
echo -e "${yl}│   $yy 2$wh.  VMESS $wh  $yy[${wh}Menu$yy]      $y┃$yy 8$wh.  LIMIT SPEED$wh $yy[${wh}Menu$yy]   │${yl}"  
echo -e "${yl}│   $yy 3$wh.  VLESS $wh  $yy[${wh}Menu$yy]      $y┃$yy 9$wh.  ADD-HOST$wh $yy[${wh}Menu$yy]   │${yl}" 
echo -e "${yl}│   $yy 4$wh.  TROJAN $wh$yy[${wh}Menu$yy]      $y┃$yy 10$wh.  BACKUP$wh $yy[${wh}Menu$yy]   │${yl}" 
echo -e "${yl}│   $yy 5$wh.  SS WS $wh  $yy[${wh}Menu$yy]      $y┃$yy 11$wh.  GEN SSL$wh $yy[${wh}Menu$yy]   │${yl}" 
echo -e "${yl}│   $yy 6$wh.  SOCK WS $wh$yy[${wh}Menu$yy]      $y┃$yy 12$wh.  RESTART SERVICE$wh $yy[${wh}Menu$yy]   │${yl}" 
echo -e "${yl}└─────────────────────────────────────────────────────────────┘${yl}"
echo -e "${yl}┌─────────────────────────────────────────────────────────────┐${NC}"
