...
echo -e " \e[36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"     
echo -e "  ${On_IRed}   ${IRed} SSH : ${On_IRed}$ressh${On_IRed}"  "${IRed} NGINX ${On_IRed}: $resngx""${On_IRed} ${IRed}  XRAY ${NC}${On_IRed}: $resv2r""${On_IRed} ${IRed} TROJAN ${NC}${On_IRed}: $resv2r${On_IRed}    ${NC}"
echo -e "  ${On_IRed} ${IRed}${On_IRed}      ${IRed}STUNNEL ${NC}${On_IRed}: $resst${On_IRed}${IRed} DROPBEAR ${NC}${On_IRed}: $resdbr${On_IRed}${IRed} SSH-WS ${NC}${On_IRed}: $ressshws${On_IRed}        ${NC}"
echo -e "${yl}┌─────────────────────────────────────────────────────────────┐${yl}"
