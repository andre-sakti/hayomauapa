...
echo -e " \e[36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"     
echo -e " \E[0;41;37m   $yl SSH : $gr$ressh$gr"  "${BICyan} NGINX ${On_IRed}: $resngx""${On_IRed} ${BICyan}  XRAY ${NC}${On_IRed}: $resv2r""${On_IRed} ${BICyan} TROJAN ${NC}${On_IRed}: $resv2r${On_IRed}             \E[0m"
echo -e " \E[0;41;37m      $yl STUNNEL $gr: $gr$resst$$gr $yl DROPBEAR $yl: $gr$resdbr$gr $yl SSH-WS $yl: $gr$ressshws$gr                 \E[0m"
echo -e "${yl}┌─────────────────────────────────────────────────────────────┐${yl}"
echo -e "${yl}│   $yy 1$wh.  SSH $wh    $yy[${wh}Menu$yy]      $yl┃$yy 7$wh.   BANDWIDTH$wh        $yy[${wh}Menu$yy]    ${yl}│${yl}"
echo -e "${yl}│   $yy 2$wh.  VMESS $wh  $yy[${wh}Menu$yy]      $yl┃$yy 8$wh.   LIMIT SPEED$wh      $yy[${wh}Menu$yy]   ${yl}│${yl}"  
echo -e "${yl}│   $yy 3$wh.  VLESS $wh  $yy[${wh}Menu$yy]      $yl┃$yy 9$wh.   ADD-HOST$wh         $yy[${wh}Menu$yy]   ${yl}│${yl}" 
echo -e "${yl}│   $yy 4$wh.  TROJAN $wh $yy[${wh}Menu$yy]      $yl┃$yy 10$wh.  BACKUP$wh          $yy[${wh}Menu$yy]    ${yl}│${yl}" 
echo -e "${yl}│   $yy 5$wh.  SS WS $wh  $yy[${wh}Menu$yy]      $yl┃$yy 11$wh.  GEN SSL$wh         $yy[${wh}Menu$yy]   ${yl}│${yl}" 
echo -e "${yl}│   $yy 6$wh.  SOCK WS $wh$yy[${wh}Menu$yy]      $yl┃$yy 12$wh.  RESTART SERVICE$wh $yy[${wh}Menu$yy]   ${yl}│${yl}" 
echo -e "${yl}└─────────────────────────────────────────────────────────────┘${yl}"
echo -e "${yl}┌─────────────────────────────────────────────────────────────┐${NC}"
