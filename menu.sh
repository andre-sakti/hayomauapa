...
echo -e " \e[36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"     
echo -e "  ${BIRed}   ${BICyan} SSH : ${BIRed}$ressh${BIRed}"  "${BICyan} NGINX ${BIRed}: $resngx""${BIRed} ${BICyan}  XRAY ${NC}${BIRed}: $resv2r""${BIRed} ${BICyan} TROJAN ${NC}${BIRed}: $resv2r${BIRed}    ${NC}"
echo -e "  ${BIRed} ${BICyan}${BIRed}      ${BICyan}STUNNEL ${NC}${BIRed}: $resst${BIRed}${BICyan} DROPBEAR ${NC}${BIRed}: $resdbr${BIRed}${BICyan} SSH-WS ${NC}${BIRed}: $ressshws${BIRed}        ${NC}"
echo -e "${yl}┌─────────────────────────────────────────────────────────────┐${yl}"
