...
echo -e " \e[36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"     
echo -e "  ${IRed}   ${BICyan} SSH : ${IRed}$ressh${IRed}"  "${BICyan} NGINX ${IRed}: $resngx""${IRed} ${BICyan}  XRAY ${NC}${IRed}: $resv2r""${IRed} ${BICyan} TROJAN ${NC}${IRed}: $resv2r${IRed}    ${NC}"
echo -e "  ${IRed} ${BICyan}${IRed}      ${BICyan}STUNNEL ${NC}${IRed}: $resst${BIRed}${BICyan} DROPBEAR ${NC}${IRed}: $resdbr${IRed}${BICyan} SSH-WS ${NC}${IRed}: $ressshws${IRed}        ${NC}"
echo -e "${yl}┌─────────────────────────────────────────────────────────────┐${yl}"
