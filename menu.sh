...
echo -e " \e[36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"     
echo -e "  ${On_IPurple}   ${BICyan} SSH : ${On_IRed}$ressh${On_IPurple}"  "${BICyan} NGINX ${On_IRed}: $resngx""${On_IPurple} ${BICyan}  XRAY ${NC}${On_IRed}: $resv2r""${On_IPurple} ${BICyan} TROJAN ${NC}${On_IRed}: $resv2r${On_IPurple}    ${NC}"
echo -e "  ${On_IPurple} ${BICyan}${On_IPurple}      ${BICyan}STUNNEL ${NC}${On_IRed}: $resst${On_IPurple}${BICyan} DROPBEAR ${NC}${On_IRed}: $resdbr${On_IPurple}${BICyan} SSH-WS ${NC}${On_IRed}: $ressshws${On_IPurple}        ${NC}"
echo -e "${yl}┌─────────────────────────────────────────────────────────────┐${yl}"
