...
echo -e "  \e[$yy Free RAM             : $fram MB $text"
echo -e "  \e[$yy System Uptime        : $uptime $text"
echo -e "  \e[$yy Ip Vps/Address       : $IPVPS $text"
echo -e "  \e[$yy Domain Name          : $Domen\e[0m"
echo -e "  \e[$yy Order ID             : $Nama_Issued_License\e[0m"
echo -e "  \e[$yy Expired Status       : $(cat /etc/${Auther}/license-remaining-active-days.db)\e[0m"
echo -e "  \e[$yy Provided By          : Script Credit by Andre Sakti\e[0m"
echo -e "  \e[$yy Status Update        :$stl $text"
echo -e " \e[$line╒════════════════════════════════════════════════════════════╕\e[m"
