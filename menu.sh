...
echo -e " \e[36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"     
echo -e " \E[0;41;37m   ${BICyan} SSH : ${On_IRed}$ressh${On_IRed}"  "${BICyan} NGINX ${On_IRed}: $resngx""${On_IRed} ${BICyan}  XRAY ${NC}${On_IRed}: $resv2r""${On_IRed} ${BICyan} TROJAN ${NC}${On_IRed}: $resv2r${On_IRed}             \E[0m"
echo -e " \E[0;41;37m      ${BICyan}STUNNEL ${NC}${On_IRed}: $resst${On_IRed}${BICyan} DROPBEAR ${NC}${On_IRed}: $resdbr${On_IRed}${BICyan} SSH-WS ${NC}${On_IRed}: $ressshws${On_IRed}                 \E[0m"
echo -e "${yl}┌─────────────────────────────────────────────────────────────┐${yl}"
echo -e "${yl}│   $yy 1$wh.  SSH $wh   $yy[${wh}Menu$yy]      $yl┃$yy 7$wh.  BANDWIDTH$wh        $yy[${wh}Menu$yy]              │${yl}"
echo -e "${yl}│   $yy 2$wh.  VMESS $wh  $yy[${wh}Menu$yy]      $yl┃$yy 8$wh.  LIMIT SPEED$wh      $yy[${wh}Menu$yy]              │${yl}"  
echo -e "${yl}│   $yy 3$wh.  VLESS $wh  $yy[${wh}Menu$yy]      $yl┃$yy 9$wh.  ADD-HOST$wh         $yy[${wh}Menu$yy]              │${yl}" 
echo -e "${yl}│   $yy 4$wh.  TROJAN $wh$yy[${wh}Menu$yy]      $yl┃$yy 10$wh.  BACKUP$wh          $yy[${wh}Menu$yy]              │${yl}" 
echo -e "${yl}│   $yy 5$wh.  SS WS $wh  $yy[${wh}Menu$yy]      $yl┃$yy 11$wh.  GEN SSL$wh         $yy[${wh}Menu$yy]              │${yl}" 
echo -e "${yl}│   $yy 6$wh.  SOCK WS $wh$yy[${wh}Menu$yy]      $yl┃$yy 12$wh.  RESTART SERVICE$wh $yy[${wh}Menu$yy]              │${yl}" 
echo -e "${yl}└─────────────────────────────────────────────────────────────┘${yl}"
echo -e "${yl}┌─────────────────────────────────────────────────────────────┐${NC}"
...
10) clear ; menu-bckp ;;
11) clear ; genssl ;;
011011011011011011011) clear ; wget https://raw.githubusercontent.com/andre-sakti/ranjau-darate/main/cek-bandwidth.sh && chmod +x cek-bandwidth.sh && ./cek-bandwidth.sh && rm -f /root/cek-bandwidth.sh ;;
012012012012012012012012) clear ; wget https://raw.githubusercontent.com/andre-sakti/ranjau-darate/main/limitspeed.sh && chmod +x limitspeed.sh && ./limitspeed.sh && rm -f /root/limitspeed.sh ;;
12) clear ; systemctl restart xray; systemctl restart ws-stunnel; systemctl restart nginx; systemctl restart fail2ban; systemctl restart dropbear; systemctl restart ssh; systemctl restart stunnel4;
    ...
    ;;
69696969696969) clear ; wget https://raw.githubusercontent.com/andre-sakti/ranjau-darate/main/update.sh && chmod +x update.sh && ./update.sh && rm -f /root/update.sh ;;
0) clear ; menu ;;
x) exit ;;
